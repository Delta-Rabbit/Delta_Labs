/**
 * Delta Labs Wishlist Course Card Component
 * Single unified course card for wishlist with all features integrated
 */
  ...
  return (
    <div className="relative w-full bg-white rounded-xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
      ...
      <div className="absolute left-4 top-4 z-10">
        <input
          type="checkbox"
          id={`wishlist-checkbox-${course.id}`}
          checked={isSelected}
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-semibold bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors flex-1 min-w-[100px]"
          >
            Enroll
          </button>
        </div>
