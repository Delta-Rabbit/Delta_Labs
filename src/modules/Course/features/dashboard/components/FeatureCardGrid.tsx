...
const FeatureCardGrid: React.FC = () => {
  ...
  const featureCards = [
    {
      ...
      icon: (
        <svg className="w-16 h-16 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  return (
    <div className="grid grid-cols-2 gap-6 font-primary">
