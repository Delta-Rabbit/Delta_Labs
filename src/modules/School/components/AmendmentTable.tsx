...
const mockData: OfferData[] = Array.from({ length: 10 }, (_, i) => ({
  ...
  date: `1/${30 + i}/2025`,
  detail: "Detail",
  status: i % 2 === 0 ? "Waiting" : "responded",
...
function AmendmentTable({ searchQuery = "" }: AmendmentTableProps) {
  ...
  const handleDownload = () => {
    ...
    link.href = url
    link.download = "amendment_schools.json"
    ...
    <div className="w-full">
      ...
      <div className="overflow-x-auto">
        <div className="flex">
          ...
          >
            <table className="border-collapse min-w-[1100px] select-none">
              <thead>
                <tr className="bg-gray-200">
                  ...
                  <th className="p-3 text-left text-sm font-semibold text-[#174a5f] min-w-[200px] h-[57px]">Status</th>
                  <th className="p-3 text-left text-sm font-semibold text-[#174a5f] min-w-[200px] h-[57px]">Reconsider</th>
                </tr>
              </thead>
              <tbody>
                {filteredData.map((row) => {
                  ...
                  return (
                    <tr key={row.id} className="border-b border-gray-200">
                      ...
                      <td className="p-3 bg-[#b4e1b0] text-sm text-gray-700 min-w-[200px] h-[57px]">
                        {row.status === "Waiting" ? (
                      ...
                      <td className="p-3 bg-[#e1b0b0] text-sm text-gray-700 min-w-[200px] h-[57px]">{row.reconsider}</td>
                    </tr>
                  )
                })}
              </tbody>
