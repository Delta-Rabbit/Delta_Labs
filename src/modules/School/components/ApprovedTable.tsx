...
function ApprovedTable({ searchQuery = "" }: ApprovedTableProps) {
  ...
  const handleDownload = () => {
    ...
    link.href = url
    link.download = "approved_schools.json"
    ...
    <div className="w-full">
      ...
      <div className="overflow-x-auto">
        <div className="flex">
          ...
          >
            <table className="border-collapse min-w-[1000px] select-none">
              <thead>
                <tr className="bg-gray-200">
                  ...
                  <th className="p-3 text-left text-sm font-semibold text-[#174a5f] min-w-[200px] h-[57px]">Manage</th>
                </tr>
              </thead>
              <tbody>
                {filteredData.map((row) => {
                  ...
                  return (
                    <tr key={row.id} className="border-b border-gray-200">
                      ...
                      <td className="p-3 bg-[#b4e1b0] text-sm text-gray-700 min-w-[200px] h-[57px]">{row.manage}</td>
                    </tr>
                  )
                })}
              </tbody>
